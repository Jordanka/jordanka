(function($, Hbars){
  ...
  //___________GENERAL_____________
    ...
    var prepareDetails = function(thumb){
      ...
      var skillsArray = workData.skills.split(',');
      $detSkills.text('');
      $.each(skillsArray, function(key, skill){
        $detSkills.append($('<img>',{src:'../assets/tech/'+skill+'.jpg'}));
      });
	...
	$dgWorks.on("click", function(){
		displayView("list","Diseño Gráfico");	
	});

	$diWorks.on("click", function(){
		displayView("list","Diseño Industrial");	
	});
